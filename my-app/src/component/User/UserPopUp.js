...
const UserPopUp = ({ user, setUser }) => {
  const { active, setActive, addUser, exit, setExit, roleList } =
    useContext(UserContext);
  const { setRole, initialValue, editing, setEditing } =
          ...
          <div className="body">
            ...
            <div>
              <input
                ...
                checked={exit}
              />
              <label className="ms-2" htmlFor="exit">
                Exit on checked
              </label>
            </div>
